...
#define CHARACTERISTIC_UUID "00002a6e-0000-1000-8000-00805f9b34fb" // Temperature characteristic
...
class MyServerCallbacks: public BLEServerCallbacks {
    ...
    void onDisconnect(BLEServer* pServer) {
      ...
      // Reiniciar la publicidad cuando se desconecte
...
void setup() {
  ...
  // BlueTooth.begin(9600);
   ...
   pAdvertising->setMinPreferred(0x06);  // funciones para iPhone
